...
class ReUserInterface_13 extends StatefulWidget {
  const ReUserInterface_13({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_13> createState() => _ReUserInterface_13State();
}

class _ReUserInterface_13State extends State<ReUserInterface_13> {
      ...
      child: Container(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor: Color(0XFF8CE3DB),
            title: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                      'assets/images/ic_phone_in_talk_24px.png'),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: Center(
                                      child: Text(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                      'assets/images/ic_local_post_office_24px.png'),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: Center(
                                      child: Text(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                      'assets/images/whatsapp-fill-svgrepo-com.png'),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 5.0),
                                    child: Center(
                                      child: Text(
