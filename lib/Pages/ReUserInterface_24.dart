...
class ReUserInterface_24 extends StatefulWidget {
  const ReUserInterface_24({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_24> createState() => _ReUserInterface_24State();
}

class _ReUserInterface_24State extends State<ReUserInterface_24> {
  @override
            ...
            child: Column(
              ...
              children: [
                    ...
                    Row(
                      children: [
                        Container(
                            width: 34.0,
                            height: 24.0,
                            child: Image.asset('assets/images/furniture-store-svgrepo-com@3x.png')),
                        SizedBox(width: 6.0,),
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Furnished',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Unfurnished',style: TextStyle(
                        fontSize:16 ,
                        fontFamily:'Montserrat' ,
                        fontWeight:FontWeight.bold ,
                        color: Color(0XFF272D3B)
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Party Furnished',style: TextStyle(
                        fontSize:16 ,
                        fontFamily:'Montserrat' ,
                        fontWeight:FontWeight.bold ,
                        color: Color(0XFF272D3B)
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Kitchen Only',style: TextStyle(
                        fontSize:16 ,
                        fontFamily:'Montserrat' ,
                        fontWeight:FontWeight.bold ,
                        color: Color(0XFF272D3B)
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Only Major Appliances',style: TextStyle(
                        fontSize:16 ,
                        fontFamily:'Montserrat' ,
                        fontWeight:FontWeight.bold ,
                        color: Color(0XFF272D3B)
