...
class ReUserInterface_27 extends StatefulWidget {
  const ReUserInterface_27({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_27> createState() => _ReUserInterface_27State();
}

class _ReUserInterface_27State extends State<ReUserInterface_27> {
  @override
          ...
          child: Column(
            ...
            children: [
                  ...
                  Row(
                    children: [
                      Container(
                          width: 34.0,
                          height: 24.0,
                          child: Image.asset('assets/images/Status_Image.png')),
              ...
              Container(
                ...
                child: Center(
                  child: Text('New Building',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
              ...
              Container(
                ...
                child: Center(
                  child: Text('Second Hand',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
              ...
              Container(
                ...
                child: Center(
                  child: Text('Requires Restoration',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
              ...
              Container(
                ...
                child: Center(
                  child: Text('Shell and Core',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
