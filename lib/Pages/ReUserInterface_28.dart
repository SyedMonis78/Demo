...
class ReUserInterface_28 extends StatefulWidget {
  const ReUserInterface_28({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_28> createState() => _ReUserInterface_28State();
}

class _ReUserInterface_28State extends State<ReUserInterface_28> {
  @override
          ...
          child: Column(
            ...
            children: [
                  ...
                  Row(
                    children: [
                      Container(
                          width: 34.0,
                          height: 24.0,
                          child: Image.asset('assets/images/stairs-floor-svgrepo-com@3x.png')),
                      Text('Floor Level' ,style: TextStyle(
                        fontSize: 22.0,
              ...
              Container(
                ...
                child: Center(
                  child: Text('6-10',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
              ...
              Container(
                ...
                child: Center(
                  child: Text('Top Level',style: TextStyle(
                      fontSize:16 ,
                      fontFamily:'Montserrat' ,
                      fontWeight:FontWeight.bold ,
                      color: Color(0XFF272D3B)
