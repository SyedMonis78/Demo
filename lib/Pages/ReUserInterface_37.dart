...
class ReUserInterface_37 extends StatefulWidget {
  const ReUserInterface_37({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_37> createState() => _ReUserInterface_37State();
}

class _ReUserInterface_37State extends State<ReUserInterface_37> {
  @override
                          ...
                          Row(
                            children: [
                              Container(
                                width: 25,
                                height: 25,
                                child: Image.asset('assets/images/Mask Group 103@3x.png'),
                              ),

                              Container(
                                child: Text('Area in m2' , style: TextStyle(
                                    fontSize: 25,
