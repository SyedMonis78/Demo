...
class ReUserInterface_45 extends StatefulWidget {
  const ReUserInterface_45({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_45> createState() => _ReUserInterface_45State();
}

class _ReUserInterface_45State extends State<ReUserInterface_45> {
              ...
              Row(
                ...
                children: [
                  Container(
                    width: 411,
                    height: 470,
                    child: Image.asset('assets/images/StreetView.jpg',fit: BoxFit.cover,),
                  ),
                ],
              )
            ],
