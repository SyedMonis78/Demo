...
class ReUserInterface_46 extends StatefulWidget {
  const ReUserInterface_46({Key? key}) : super(key: key);

  @override
  State<ReUserInterface_46> createState() => _ReUserInterface_46State();
}

class _ReUserInterface_46State extends State<ReUserInterface_46> {
              ...
              Row(
                ...
                children: [
                  Container(
                    width: 411,
                    height: 580,
                    child: Image.asset('assets/images/location_46.jfif',fit: BoxFit.cover,),
                  ),
                ],
              )
            ],
